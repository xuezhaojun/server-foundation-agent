...
```
Phase 1: Collect    →  Phase 2: Analyze        →  Phase 3: Report    →  Phase 4: Distribute
sfa-jira-search        sub-agents per bug          generate Slack         sfa-slack-notify
(status=New, type=Bug)  (codebase deep-dive)        payload
```
